        ...
        return <div class = "education">
            ...
            <div class="resume-section p-3 p-lg-5 d-flex align-items-center">
                <div class="text-left">
                    ...
                    <p class = "text-muted">
                        GPA: 3.39/4.00<br></br>
                        Relevant Courses: EECS 485 - Websystems, EECS 388 - Introduction to Computer Security, EECS 376 - Foundations of Computer Science, EECS 370 - Computer Organization, EECS 281 - Data Structures and Algorithms, EECS 280 - Programming and Introductory Data Structures, EECS 203 - Discrete Math, ENGR 151 - Accelerated Introduction to Computer Programming
                    </p>
                </div>
            </div>
            </section>
